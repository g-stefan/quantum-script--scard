...
echo -^> local-release quantum-script-extension-scard
...
call :cmdX xyo-cc quantum-script-extension-scard --archive-release-sha512 --version-file=source/quantum-script-extension-scard.version.ini
